...
int main(int argc, char **argv) {
  ...
  // Launch our ros node
  ros::init(argc, argv, "run_subscribe_cuahn");
  ros::NodeHandle nh("~");
...
void callback_inertial(const sensor_msgs::Imu::ConstPtr &msg) {
  ...
  viz->visualize(); // comment this when onboard feedback control
  viz->visualize_odometry(message.timestamp); // for onboard feedback control and logging velocity
}
